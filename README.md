...
> `sigp/lighthouse` glamsterdam devnet branch (currently `glamsterdam-devnet-7`)
...
> `ethpandaops/dimhouse:gloas-devnet-7` (rolling) and
> `ethpandaops/dimhouse:gloas-devnet-7-<sha>` (pinned) images.
