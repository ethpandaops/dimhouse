...
pub enum EventData {
    ...
    #[serde(rename = "DATA_COLUMN_SIDECAR_GLOAS")]
    ...
    #[serde(rename = "EXECUTION_PAYLOAD_ENVELOPE")]
    ...
    #[serde(rename = "EXECUTION_PAYLOAD_BID")]
    ExecutionPayloadBid {
        peer_id: String,
        slot: u64,
        epoch: u64,
        ...
        gas_limit: u64,
        blob_kzg_commitment_count: u32,
        timestamp_ms: i64,
        message_id: String,
        topic: String,
        message_size: u32,
    },
    #[serde(rename = "PAYLOAD_ATTESTATION_MESSAGE")]
